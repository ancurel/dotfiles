...
let g:colors_name="Miami Night Truecolor"
...
exe "hi! cssDefinition"     .s:fg_blue_light   .s:bg_none        .s:fmt_none
exe "hi! cssImportant"      .s:fg_blue         .s:bg_none        .s:fmt_none
exe "hi! cssAttr"           .s:fg_foreground   .s:bg_none        .s:fmt_none
exe "hi! cssValueLength"    .s:fg_foreground   .s:bg_none        .s:fmt_none
exe "hi! cssValueNumber"    .s:fg_foreground   .s:bg_none        .s:fmt_none
exe "hi! cssColor"          .s:fg_blue_light   .s:bg_none        .s:fmt_none
exe "hi! cssUnitDecorators" .s:fg_foreground   .s:bg_none        .s:fmt_none
exe "hi! cssIncludeKeyword" .s:fg_cyan         .s:bg_none        .s:fmt_none
exe "hi! cssPseudoClassId"  .s:fg_white        .s:bg_none        .s:fmt_none
